...
CREATE PROCEDURE [trans].[sp_rpt_data_interface_20191018NewMAIOFUK5_v4_1stSend]
@FILE_DATE DATE,
@LOCATION_ID INT,
@USER_ID INT
AS
...
from (
	...
	from (
		...
		from (
			...
			where mr.recorded_at between @FILE_DATE and DATEADD(hour,16,convert(datetime,@FILE_DATE))
