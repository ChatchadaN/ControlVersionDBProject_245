...
-- =============================================
CREATE PROCEDURE [trans].[sp_set_b_lot_qty_bak]
...
BEGIN
	...
	WHERE APCSProDB.trans.lots.lot_no like '%b%' and APCSProDB.trans.lots.qty_in = '0' 
	...
	WHERE APCSDB.dbo.LOT1_TABLE.lot_no like '%b%' and APCSDB.dbo.LOT1_TABLE.PRD_PIECE = '0';
END
