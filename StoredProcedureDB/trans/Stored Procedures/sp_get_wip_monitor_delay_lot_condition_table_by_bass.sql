...
-- =============================================
CREATE PROCEDURE [trans].[sp_get_wip_monitor_delay_lot_condition_table_by_bass]
...
BEGIN
	...
	SELECT @day_delay_condition =  [daycondition] FROM [APCSProDWH].[cac].[day_delay_condition]
		...
		begin 
			...
			and (
				[wip_monitor_delay_lot_condition_detail].[incharge] like '%jeena%'
				or [wip_monitor_delay_lot_condition_detail].[status] like '%error%'
				or [wip_monitor_delay_lot_condition_detail].[status] like '%delete%'
				or [wip_monitor_delay_lot_condition_detail].[status] like '%hasuu%'
		...
		begin
			...
			where (
				[wip_monitor_no_movement_lot_detail].[incharge] like '%jeena%'
				or [wip_monitor_no_movement_lot_detail].[status] like '%error%'
				or [wip_monitor_no_movement_lot_detail].[status] like '%delete%'
				or [wip_monitor_no_movement_lot_detail].[status] like '%hasuu%'
