...
CREATE PROCEDURE [trans].[sp_rpt_data_interface_temp]
@FILE_DATE DATE,
@LOCATION_ID INT,
@USER_ID INT
AS
BEGIN
	...
	DELETE FROM [APCSPRODWH].[DBO].[adm00001_temp]

-- ************** FUK5 ************** --
INSERT [APCSPRODWH].[DBO].[adm00001_temp] ([WRITETIME] ,[SEQNO6] ,[ROVANSFILE] ,[ROVANSDATA] ,[SENDENDFL] ,[MAKDT] ,[MAKP] ,[MAKC] ,[UPDDT] ,[UPDP] ,[UPDC] ,[DELF] ,[DELDT] ,[DELP] ,[DELC])
select t3.writetime
	,t3.seqno6
	,t3.rovansfile
...
--  SELECT * FROM [APCSPRODWH].[DBO].[adm00001_temp] WHERE rovansfile = 'MAIO' ORDER BY UPDDT DESC