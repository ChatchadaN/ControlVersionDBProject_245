...
-- =============================================
CREATE PROCEDURE [trans].[sp_get_wip_monitor_delay_lot_condition_table_testbass]
...
BEGIN
	...
	BEGIN
		...
		, iif([lots].[updated_at] is not null ,(case when [lots].[updated_at] <= @date_value then 1 else 0 end), 1) as [status_fillter]
