...
-- =============================================
CREATE PROCEDURE [mdm].[sp_set_edit_roles]
...
BEGIN
	...
	BEGIN TRANSACTION
		...
		IF NOT EXISTS (SELECT  'xx' FROM  [APCSProDB].[man].[roles] WHERE [name] = @role_name  AND descriptions = @descriptions)
		BEGIN  
