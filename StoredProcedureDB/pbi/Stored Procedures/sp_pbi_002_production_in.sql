...
-- =============================================
CREATE PROCEDURE [pbi].[sp_pbi_002_production_in] (
...
　	    ,LPR.OperatingCategory	
		,Case when (LPR_Before.qty_pass <= 0 or LPR_Before.qty_pass is null) then LPR_Before.qty_in - LPR_Before.qty_fail else LPR_Before.qty_pass end as 'ActQty1'
		,LPR.ActQtyLot1
		,LPR.ActQty2
		,LPR.ActQtyLot2
		,LPR.InOut
...
　	    ,'' as 'OperatingCategory'	
		...
		,0 as 'ActQty2'
		,0 as 'ActQtyLot2'
		,case when DF.step_no = 100 and PR.name = 'DB' then '1'
		 else '' end as 'InOut'
		,'' as 'RunPlanstop' 
