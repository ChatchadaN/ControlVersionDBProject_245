...
-- =============================================
CREATE PROCEDURE [jig].[sp_get_hp_pp_checkframetype_v2]
...
BEGIN
	...
	BEGIN
		...
		SET @FrameLot = (SELECT CASE WHEN (CHARINDEX(' ',FrameNo)) > 0 THEN  SUBSTRING(FrameNo,1,(CHARINDEX(' ',FrameNo) -1)) ELSE FrameNo END AS FrameNo From [DBx].[dbo].[TransactionData] where LotNo = @LotNo)
