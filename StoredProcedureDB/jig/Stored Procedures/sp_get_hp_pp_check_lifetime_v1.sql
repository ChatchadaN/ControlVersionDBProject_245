...
-- =============================================
CREATE  PROCEDURE [jig].[sp_get_hp_pp_check_lifetime_v1]
...
BEGIN
	...
	SET @STDLifeTime = (SELECT APCSProDB.jig.productions.expiration_value 
	...
	SET @Period =		(SELECT APCSProDB.jig.production_counters.alarm_value  
						FROM APCSProDB.trans.jigs INNER JOIN
