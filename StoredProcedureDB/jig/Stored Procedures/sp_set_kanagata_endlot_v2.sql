...
-- =============================================
CREATE PROCEDURE [jig].[sp_set_kanagata_endlot_v2] 
	-- Add the parameters for the stored procedure here
		...
		@BigSpringMax as INT = 0,
		@SmallSpringMax as INT = 0,
		@FinGateGuidePunchMax as INT = 0,
		@StripperBoltMax as INT = 0,
		@PressLinkUnitCheckMax as INT = 0,
		@KanagataPeriodicalCheckMax as INT = 0,
		@ScrewLockBaseShooter as INT = 0
AS
BEGIN
	...
	BEGIN TRY
		INSERT INTO APCSProDB.trans.jig_records ([day_id],[record_at],[jig_id],[jig_production_id],[location_id],[created_at],[created_by],[operated_by],transaction_type,extend_data,lot_no,record_class,mc_no) 
					...
					CONVERT(XML,(SELECT @Package as Package,@LOTNO as LotNo,@KanagataName as KanagataName,@MCNO as MCNo,@MCType as MCType,
							...
							@BigSpringMax as BigSpringMax,
							@SmallSpringMax as SmallSpringMax,
							@FinGateGuidePunchMax as FinGateGuidePunchMax,
							@StripperBoltMax as StripperBoltMax,
							@PressLinkUnitCheckMax as PressLinkUnitCheckMax,
							@KanagataPeriodicalCheckMax as KanagataPeriodicalCheckMax,
							@ScrewLockBaseShooter as ScrewLockBaseShooter
