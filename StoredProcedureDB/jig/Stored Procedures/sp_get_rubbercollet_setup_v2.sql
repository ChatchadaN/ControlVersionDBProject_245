...
-- =============================================
CREATE PROCEDURE [jig].[sp_get_rubbercollet_setup_v2]
...
BEGIN
	...
	BEGIN
			SELECT    'FALSE'																															AS Is_Pass
					, N'Miss match RubberNo ('+ @RubberNO +') is not register or This Machine Type ('+ @MCType +') registration is invalid. !!'			AS Error_Message_ENG
