...
CREATE PROCEDURE [etl].[sp_etl_2-09_fact_shipment_rev3] (@v_ProServerName NVARCHAR(128) = ''
...
BEGIN
	...
	SET @sqltmp = @sqltmp + N'	,case when t1.pcs_per_pack = 0 then t1.qty_pass else t1.qty_pass - (t1.qty_pass % t1.pcs_per_pack) end as ship '; 
