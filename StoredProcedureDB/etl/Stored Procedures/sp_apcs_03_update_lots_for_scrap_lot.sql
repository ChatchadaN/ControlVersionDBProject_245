CREATE PROCEDURE [etl].[sp_apcs_03_update_lots_for_scrap_lot] (
...
*/
	...
	SET @pSqlUpdate = @pSqlUpdate + N'	wip_state = 210 ';
	SET @pSqlUpdate = @pSqlUpdate + N'	,updated_at = l2.REAL_DAY ';
	SET @pSqlUpdate = @pSqlUpdate + N'	,updated_by = null ';
	SET @pSqlUpdate = @pSqlUpdate + N'	,carrier_no = null ';
	SET @pSqlUpdate = @pSqlUpdate + N'	,next_carrier_no = null ';
	...
	SET @pSqlUpdate = @pSqlUpdate + N'	and l2.STATUS2 = 9';
    ...
    ---------------------------------------------------------------------------
 	...
 	BEGIN TRY
		...
		BEGIN TRANSACTION;
			...
			SET @logtext = 'Update(scrap lots) OK : row=' ;
