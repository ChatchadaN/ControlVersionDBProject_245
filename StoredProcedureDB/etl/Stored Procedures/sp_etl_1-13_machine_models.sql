...
-- Description:	<>
-- =============================================
CREATE PROCEDURE [etl].[sp_etl_1-13_machine_models] (@ServerName_APCSPro NVARCHAR(128) 
...
BEGIN
	...
	SET @sqlSelect = @sqlSelect + N'		from ';
	SET @sqlSelect = @sqlSelect + N'			' + @pObjAPCSPro + N'.[mc].models mc with (NOLOCK) ';
	SET @sqlSelect = @sqlSelect + N'			left outer join ' + @pObjAPCSProDWH + N'.[dwh].[dim_machine_models] dwh with (NOLOCK) ';
			...
			BEGIN
				...
				IF @update_flg = 1	--INSERT
					BEGIN
		 				...
		 				SET @sqlTreat = N'';
						SET @sqlTreat = @sqlTreat + N'insert into ' + @pObjAPCSProDWH + N'.[dwh].[dim_machine_models] ';
					...
					BEGIN
						SET @sqlTreat = N'';
						SET @sqlTreat = @sqlTreat + N'update ' + @pObjAPCSProDWH + N'.[dwh].[dim_machine_models] WITH (ROWLOCK) ';
