...
BEGIN
	...
	left join [APCSProDB].[man].[user_roles] on [APCSProDB].[man].[users].id = [APCSProDB].[man].[user_roles].user_id
    left join [APCSProDB].[man].[roles] on [APCSProDB].[man].[user_roles].role_id =[APCSProDB].[man].[roles].id
	left join [APCSProDB].[man].[role_permissions] on [APCSProDB].[man].[roles].id = [APCSProDB].[man].[role_permissions].role_id
	left join [APCSProDB].[man].[permissions] on [APCSProDB].[man].[role_permissions].permission_id = [APCSProDB].[man].[permissions].id
