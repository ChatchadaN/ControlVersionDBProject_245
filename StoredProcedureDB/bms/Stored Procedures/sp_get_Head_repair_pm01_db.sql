...
-- =============================================
CREATE PROCEDURE [bms].[sp_get_Head_repair_pm01_db]
...
BEGIN
	...
	BEGIN
		...
		from dbx.dbo.BMMaintenance,dbx.dbo.BMEmployee, dbx.dbo.BMStatus,dbx.dbo.BMPM6Detail 
		where dbx.dbo.BMMaintenance.ID = '865468'
	...
	BEGIN
		...
		where dbx.dbo.BMEmployee.ID IN (select dbx.dbo.BMPM6Detail.GL
		from dbx.dbo.BMMaintenance,dbx.dbo.BMEmployee,dbx.dbo.BMStatus,dbx.dbo.BMPM6Detail 
		where dbx.dbo.BMMaintenance.ID = '865468'
		and dbx.dbo.BMMaintenance.Requestor = dbx.dbo.BMEmployee.id 
		and dbx.dbo.BMMaintenance.statusid = dbx.dbo.BMstatus.statusid 
