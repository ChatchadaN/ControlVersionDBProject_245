...
-- =============================================
CREATE PROCEDURE [rans].[sp_get_scheduler_temp_wb] 
...
BEGIN
	...
	LEFT JOIN [APCSProDWH].[rans].[machine_state_ps] AS [machines]  WITH (NOLOCK) ON [lot_wip_plans].[machine_id] = [machines].[id]
	...
	---------------------------------------------------------------------------------------------------
	WHERE [lot_wip_plans].[process] = 'WB'
