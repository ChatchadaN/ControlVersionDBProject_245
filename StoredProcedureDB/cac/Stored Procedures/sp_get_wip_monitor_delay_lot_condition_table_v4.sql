...
-- =============================================
CREATE PROCEDURE [cac].[sp_get_wip_monitor_delay_lot_condition_table_v4]
...
BEGIN
	...
	BEGIN
		...
		--	or (DATEDIFF(DAY,[days2].[date_value],@date_value) >= @day_delay_condition and DATEDIFF(day,[lots].[updated_at],GETDATE()) <= 2)
		--)
		---- add lot test
		--and [lots].[id] <> 0
		--//2022.3.14
	...
	BEGIN		
		...
		--and [lots].[wip_state] = '20'		
		--and NOT((DATEDIFF(DAY,[days2].[date_value],@date_value) > 0
		--	or (DATEDIFF(DAY,[days2].[date_value],@date_value) >= @day_delay_condition and DATEDIFF(day,[lots].[updated_at],GETDATE()) <= 2)
		--))
		---- add lot test
		--and [lots].[id] <> 0
