...
-- =============================================
CREATE PROCEDURE [cac].[sp_set_wip_monitor_main]
...
BEGIN
	...
	delete from [APCSProDWH].[cac].[wip_monitor_main_temp]
	insert into [APCSProDWH].[cac].[wip_monitor_main_temp]
	([date_value]
		,[package_group]
		,[package]
		,[process]
	...
	delete from [APCSProDWH].[cac].[wip_monitor_main] where [date_value] = @date_value
	insert into [APCSProDWH].[cac].[wip_monitor_main]
	([date_value]
		,[package_group]
		,[package]
		,[process]
	...
	select [date_value]
		...
		,[order_delay_special]
		,[order_delay_special_pcs]
	from [APCSProDWH].[cac].[wip_monitor_main_temp] with (NOLOCK)
