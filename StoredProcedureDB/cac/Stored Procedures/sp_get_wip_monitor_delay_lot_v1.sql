...
-- =============================================
CREATE PROCEDURE [cac].[sp_get_wip_monitor_delay_lot_v1]
...
BEGIN
	...
	BEGIN
		...
		--	and [packages].[name] like @package
		--	and SUBSTRING([lots].[lot_no],5,1) like @lot_type
		--	group by [package_groups].[name], CONVERT(int, CEILING((DATEDIFF(DAY,[days2].[date_value],@date_value)-10)/10.0))) as [counter] on [counter].[package_group] = [master_data].[package_group] and [counter].[range_group] = [master_data].[range_group]
		--bass comment
