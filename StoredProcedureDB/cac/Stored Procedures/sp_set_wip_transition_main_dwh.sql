...
-- =============================================
CREATE PROCEDURE [cac].[sp_set_wip_transition_main_dwh]
...
BEGIN
	...
	delete from [10.29.1.230].[DWH].[cac].[wip_transition_main] where [date_value] = @date_value and [product_family] = 'LSI IC'
