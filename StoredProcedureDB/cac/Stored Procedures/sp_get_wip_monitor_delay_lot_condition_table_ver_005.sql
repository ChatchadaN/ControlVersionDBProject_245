...
-- =============================================
CREATE PROCEDURE [cac].[sp_get_wip_monitor_delay_lot_condition_table_ver_005]
...
BEGIN
	...
	BEGIN		
		...
		where 
		--[day_indate].[date_value] <= convert(date, getdate())
		--and 
		[lots].[wip_state] in (10,20,0)
