...
-- =============================================
CREATE PROCEDURE [atom].[sp_set_clear_special_flow_ver_008]
...
BEGIN
	...
	SELECT GETDATE()
		...
		, HOST_NAME()
		, APP_NAME()
		, 'EXEC [atom].[sp_set_clear_special_flow_ver_008] @lot_id = ''' + ISNULL( CAST( @lot_id AS VARCHAR ), '' ) 
	...
	SELECT GETDATE() --AS [record_at]
		...
		, APP_NAME() --AS [appname]
		, N'[StoredProcedureDB].[atom].[sp_set_clear_special_flow_ver_008]' --AS [storedprocedname]
