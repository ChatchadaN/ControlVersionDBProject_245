...
-- =============================================
CREATE PROCEDURE [atom].[sp_set_production_category_ver002]
...
BEGIN
	...
	BEGIN TRY
		...
		IF @lot_type = 'D'
		BEGIN
			SELECT 'FALSE' AS Is_Pass ,'Cannot change production_category : D !!' AS Error_Message_ENG,N'ไม่สามารถเปลี่ยน production_category : D ได้ !!' AS Error_Message_THA ,'' AS Handling	
			RETURN;
		END
