...
CREATE FUNCTION [act].[fnc_fact_wip_delay_united] (
...
BEGIN
	...
	BEGIN
		...
		FROM act.fnc_fact_wip_delay(@package_group_id, @package_id, @process_id, @device_id, @device_name, @from, @to, @hour_flag) AS t
	END
