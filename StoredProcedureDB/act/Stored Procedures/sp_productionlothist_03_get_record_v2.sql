...
CREATE PROCEDURE [act].[sp_productionlothist_03_get_record_v2] @lot_no NVARCHAR(32) = NULL
AS
BEGIN
	...
	FROM (
		...
		FROM (
			SELECT t0.id AS id
				...
				,case when t0.record_class<10 then 1 else 0 end as record_class_flag --2020-09-25 record_class=40,41対応
				,t0.qty_in AS qty_in
