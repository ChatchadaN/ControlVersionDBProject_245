...
-- =============================================
CREATE PROCEDURE [dbo].[tg_sp_set_sample_lot_test_tube]
	-- Add the parameters for the stored procedure here
	 @lotno_standard varchar(10) 
	,@lotno_standard_qty int = 0
	,@empno char(6) = ''
	,@pc_inst_code_val int = 0
	,@is_ajd_qty_standard_tube int = 0  --add parameter support work tube 2022/06/20 time : 11.03
...
BEGIN
	...
	SELECT GETDATE()
		...
		,HOST_NAME()
		,APP_NAME()
		,'EXEC [dbo].[tg_sp_set_sample_lot_test_tube] @empno = ''' + @empno + ''',@lotno_standard = ''' + @lotno_standard + ''',@lotno_standard_qty = ''' + CONVERT (varchar (10), @lotno_standard_qty) + ''''
		,@lotno_standard
