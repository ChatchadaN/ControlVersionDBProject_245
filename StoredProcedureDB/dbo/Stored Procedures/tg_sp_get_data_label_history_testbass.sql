...
-- =============================================
CREATE PROCEDURE [dbo].[tg_sp_get_data_label_history_testbass]
...
BEGIN
	...
	select @Process_Code = PROCESS_POST_CODE from APCSDB.dbo.LCQW_UNION_WORK_DENPYO_PRINT where LOT_NO_2 = @lot_no
	...
	BEGIN
		...
		BEGIN
			SELECT  
			  ...
			  ,[update_at]
			  ,[update_by]
			  --,case when @Process_Code ! = '' then @Process_Code else ' '  end as PDCD
