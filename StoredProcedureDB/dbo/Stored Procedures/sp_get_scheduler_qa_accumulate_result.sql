...
-- =============================================
CREATE PROCEDURE [dbo].[sp_get_scheduler_qa_accumulate_result]
...
where lot_record.record_class = 2  and job_id in (122,316) 
and lot_record.recorded_at between @DateStart and @DateEnd
