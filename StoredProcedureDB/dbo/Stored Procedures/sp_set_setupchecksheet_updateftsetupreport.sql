...
-- =============================================
CREATE PROCEDURE [dbo].[sp_set_setupchecksheet_updateftsetupreport]
	-- Add the parameters for the stored procedure here
	@MCNo varchar(30), @LotNo varchar(10), @PackageName varchar(20) = '', @DeviceName varchar(20) = '', @FTDevice varchar(20) = '', 
	...
	--@QRCodesocket5 varchar(30) = NULL, @QRCodesocketChannel5 varchar(30) = NULL, 
	--@QRCodesocket6 varchar(30) = NULL, @QRCodesocketChannel6 varchar(30) = NULL, 
	--@QRCodesocket7 varchar(30) = NULL, @QRCodesocketChannel7 varchar(30) = NULL, 
	--@QRCodesocket8 varchar(30) = NULL, @QRCodesocketChannel8 varchar(30) = NULL, 	
	...
	@ChannelAFTB varchar(30) = '', --@ChannelAFTBQRcode varchar(30) = NULL, 
	@ChannelBFTB varchar(30) = '', --@ChannelBFTBQRcode varchar(30) = NULL, 
	@ChannelCFTB varchar(30) = '', --@ChannelCFTBQRcode varchar(30) = NULL, 
	@ChannelDFTB varchar(30) = '', --@ChannelDFTBQRcode varchar(30) = NULL,
	@ChannelEFTB varchar(30) = '', --@ChannelEFTBQRcode varchar(30) = NULL, 
	@ChannelFFTB varchar(30) = '', --@ChannelFFTBQRcode varchar(30) = NULL,
	@ChannelGFTB varchar(30) = '', --@ChannelGFTBQRcode varchar(30) = NULL, 
	@ChannelHFTB varchar(30) = '', --@ChannelHFTBQRcode varchar(30) = NULL,
	...
	@TypeChangePackage varchar(30) = '', @SetupStartDate datetime, @SetupEndDate datetime,
	...
	@SetupStatus varchar(10), @ConfirmedCheckSheetOp varchar(15) = '', @ConfirmedCheckSheetSection varchar(15) = '', @ConfirmedCheckSheetGL varchar(15) = '', 
	@ConfirmedShonoSection varchar(15) = '', @ConfirmedShonoGL varchar(15) = '', @ConfirmedShonoOp varchar(15) = '', @StatusShonoOP varchar(5) = 0, @SocketChange int = 0, @SetupConfirmDate datetime
AS																							  															 
BEGIN																						  
 ...
 --     , [command_text])
	...
	--	,HOST_NAME()
	--	,APP_NAME()
	--	,'EXEC [dbo].[sp_set_setupchecksheet_updateftsetupreport] @MCNo = ''' + @MCNo + ''''
	...
	SET [LotNo]				= @LotNo,
		...
		--[ChannelCFTBQRcode]	= @ChannelCFTBQRcode,
		--[ChannelDFTBQRcode]	= @ChannelDFTBQRcode,
		--[ChannelEFTBQRcode]	= @ChannelEFTBQRcode,
		--[ChannelFFTBQRcode]	= @ChannelFFTBQRcode,
		--[ChannelGFTBQRcode]	= @ChannelGFTBQRcode,
		--[ChannelHFTBQRcode]	= @ChannelHFTBQRcode,
		[AdaptorA]			= @AdaptorA,
		[AdaptorB]			= @AdaptorB,
