...
-- =============================================
CREATE PROCEDURE [dbo].[sp_set_scheduler_temp_tp_ver_temp] 
...
BEGIN TRANSACTION;
BEGIN TRY
	DELETE FROM DBxDW.dbo.scheduler_temp_tp_01
	...
	INSERT INTO DBxDW.dbo.scheduler_temp_tp_01
	...
	inner join (select mcname
			...
			, case when scheduler_temp_seq_tp.[seq_no] = 1 then scheduler_temp_seq_tp.lot_start else null end as LOT1_LOTSTART
			  ...
			  left join [DBxDW].[dbo].scheduler_temp_seq_tp_01 as scheduler_temp_seq_tp on scheduler_temp_seq_tp.[machine_name] collate SQL_Latin1_General_CP1_CI_AS = scheduler_tp_qa_mc_setup.mcname) as lot
