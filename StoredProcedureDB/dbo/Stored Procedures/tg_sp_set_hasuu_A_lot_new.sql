...
-- =============================================
CREATE PROCEDURE [dbo].[tg_sp_set_hasuu_A_lot_new]
		...
		,@lotno
			...
			BEGIN CATCH
				...
				SELECT GETDATE()
					...
					, 'StoredProcedureDB'
					, 'TGSYSTEM'
					, 'EXEC [dbo].[tg_sp_set_hasuu_A_lot Insert Data TG to APCSPro InterFace] @lotno_standard = ''' + @lotno 
					, @lotno
			END CATCH
