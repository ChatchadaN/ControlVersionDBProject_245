...
-- =============================================
CREATE PROCEDURE [dbo].[tg_sp_set_hasuu_lot_manual_mix_to_is]
...
BEGIN
	...
	select @Hasuu_Qty_Before as Hasuu_Qty_Before,@EmpNo_int as EmpNo_int,@EmpNo_Char as EmpNo_Char,@op_no_len_value as op_no_len_value
