...
-- =============================================
CREATE PROCEDURE [dbo].[sp_set_data_cps]
...
BEGIN
	...
	--update apcsdb.dbo.denpyo --> apcsprodb.dbo.denpyo  #2024/04/08 time : 09.03 by aomsin
	...
	BEGIN TRY
		...
		BEGIN
			...
			select 
				...
				left join APCSProDB.dbo.LCQW_UNION_WORK_DENPYO_PRINT as den_pyo on lot.lot_no = den_pyo.LOT_NO_4
