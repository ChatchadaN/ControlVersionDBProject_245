CREATE VIEW dbo.view_scheduler_wip_v01
AS
...
WHERE             (l.wip_state = 20) AND (j.name = 'AUTO(1)') AND (l.act_package_id IN (242))
ORDER BY       l.lot_no
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Alias = 900
         Table = 1170
        ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'view_scheduler_wip_v01';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'view_scheduler_wip_v01';
