CREATE VIEW dbo.view_scheduler_wip_v03
AS
SELECT            TOP (100) PERCENT RTRIM(l.lot_no) AS [ORDER], RTRIM(p.name) AS PACKAGE, RTRIM(d.name) AS DEVICE, l.qty_pass AS QTY, dy.date_value AS DELIVERY, 100 - ISNULL(l.priority, 50) AS PRIORITY
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Alias = 2430
         Table = 1170
    ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'view_scheduler_wip_v03';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'view_scheduler_wip_v03';
