...
-- =============================================
CREATE PROCEDURE [api].[sp_create_andon_add_record_ver_001]
...
BEGIN
	...
	ELSE
	BEGIN
		SELECT @abnormal_mode = [label_eng]
		FROM [APCSProDB].[trans].[item_labels]
		WHERE [name] = 'andon_controls.comment_id_at_finding'
		AND [val] = @comment_id
