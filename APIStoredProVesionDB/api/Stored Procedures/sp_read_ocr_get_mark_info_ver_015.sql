...
-- =============================================
CREATE PROCEDURE [api].[sp_read_ocr_get_mark_info_ver_015]
	...
	BEGIN
		...
		BEGIN
			...
			, CASE WHEN LEN(CONCAT([ASSY_SYMBOL_1], [ASSY_SYMBOL_2], [ASSY_SYMBOL_3], [ASSY_SYMBOL_4], [ASSY_SYMBOL_5], [ASSY_SYMBOL_6])) 
				...
				THEN CASE WHEN (CAST([ASSY_SYMBOL_1] AS VARCHAR(MAX)) != [ASSY_SYMBOL_1]) THEN '' ELSE CASE WHEN ([ASSY_SYMBOL_1] LIKE '%*%') OR ([ASSY_SYMBOL_1] = 'MX') THEN '' ELSE [ASSY_SYMBOL_1] END END
					+ CASE WHEN (CAST([ASSY_SYMBOL_2] AS VARCHAR(MAX)) != [ASSY_SYMBOL_2]) THEN '' ELSE CASE WHEN ([ASSY_SYMBOL_2] LIKE '%*%') OR ([ASSY_SYMBOL_2] = 'MX') THEN '' ELSE [ASSY_SYMBOL_2] END END
					+ CASE WHEN (CAST([ASSY_SYMBOL_3] AS VARCHAR(MAX)) != [ASSY_SYMBOL_3]) THEN '' ELSE CASE WHEN ([ASSY_SYMBOL_3] LIKE '%*%') OR ([ASSY_SYMBOL_3] = 'MX') THEN '' ELSE [ASSY_SYMBOL_3] END END
					+ CASE WHEN (CAST([ASSY_SYMBOL_4] AS VARCHAR(MAX)) != [ASSY_SYMBOL_4]) THEN '' ELSE CASE WHEN ([ASSY_SYMBOL_4] LIKE '%*%') OR ([ASSY_SYMBOL_4] = 'MX') THEN '' ELSE [ASSY_SYMBOL_4] END END
					+ CASE WHEN (CAST([ASSY_SYMBOL_5] AS VARCHAR(MAX)) != [ASSY_SYMBOL_5]) THEN '' ELSE CASE WHEN ([ASSY_SYMBOL_5] LIKE '%*%') OR ([ASSY_SYMBOL_5] = 'MX') THEN '' ELSE [ASSY_SYMBOL_5] END END
					+ CASE WHEN (CAST([ASSY_SYMBOL_6] AS VARCHAR(MAX)) != [ASSY_SYMBOL_6]) THEN '' ELSE CASE WHEN ([ASSY_SYMBOL_6] LIKE '%*%') OR ([ASSY_SYMBOL_6] = 'MX') THEN '' ELSE [ASSY_SYMBOL_6] END END
				ELSE CASE WHEN (CAST([FT_SYMBOL_1] AS VARCHAR(MAX)) != [FT_SYMBOL_1]) THEN '' ELSE CASE WHEN ([FT_SYMBOL_1] LIKE '%*%') OR ([FT_SYMBOL_1] = 'MX') THEN '' ELSE [FT_SYMBOL_1] END END
					+ CASE WHEN (CAST([FT_SYMBOL_2] AS VARCHAR(MAX)) != [FT_SYMBOL_2]) THEN '' ELSE CASE WHEN ([FT_SYMBOL_2] LIKE '%*%') OR ([FT_SYMBOL_2] = 'MX') THEN '' ELSE [FT_SYMBOL_2] END END
					+ CASE WHEN (CAST([FT_SYMBOL_3] AS VARCHAR(MAX)) != [FT_SYMBOL_3]) THEN '' ELSE CASE WHEN ([FT_SYMBOL_3] LIKE '%*%') OR ([FT_SYMBOL_3] = 'MX') THEN '' ELSE [FT_SYMBOL_3] END END
					+ CASE WHEN (CAST([FT_SYMBOL_4] AS VARCHAR(MAX)) != [FT_SYMBOL_4]) THEN '' ELSE CASE WHEN ([FT_SYMBOL_4] LIKE '%*%') OR ([FT_SYMBOL_4] = 'MX') THEN '' ELSE [FT_SYMBOL_4] END END
					+ CASE WHEN (CAST([FT_SYMBOL_5] AS VARCHAR(MAX)) != [FT_SYMBOL_5]) THEN '' ELSE CASE WHEN ([FT_SYMBOL_5] LIKE '%*%') OR ([FT_SYMBOL_5] = 'MX') THEN '' ELSE [FT_SYMBOL_5] END END
					+ CASE WHEN (CAST([FT_SYMBOL_6] AS VARCHAR(MAX)) != [FT_SYMBOL_6]) THEN '' ELSE CASE WHEN ([FT_SYMBOL_6] LIKE '%*%') OR ([FT_SYMBOL_6] = 'MX') THEN '' ELSE [FT_SYMBOL_6] END END
				END AS [mark]
			...
			, CASE WHEN LEN(CONCAT([ASSY_SYMBOL_1], [ASSY_SYMBOL_2], [ASSY_SYMBOL_3], [ASSY_SYMBOL_4], [ASSY_SYMBOL_5], [ASSY_SYMBOL_6])) 
					>= LEN(CONCAT([FT_SYMBOL_1], [FT_SYMBOL_2], [FT_SYMBOL_3], [FT_SYMBOL_4], [FT_SYMBOL_5], [FT_SYMBOL_6]))
				THEN CAST([MANUAL_TITLE_1] AS INT) ELSE CAST([MANUAL_TITLE_2] AS INT) END AS [logo_mark]
			FROM @lot_master
