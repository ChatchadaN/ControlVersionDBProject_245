...
-- =============================================
CREATE PROCEDURE [material].[sp_set_stock_in_pd_001]
...
BEGIN
	...
	BEGIN TRY 
		...
		IF NOT EXISTS(SELECT 'xx' FROM  APCSProDB.trans.material_outgoings WHERE id  =@material_outgoings_id)
		BEGIN
		...
		BEGIN 
			...
			UPDATE  APCSProDB.trans.material_outgoings
			SET status_code = 1 
			WHERE material_outgoings.id  = @material_outgoings_id
