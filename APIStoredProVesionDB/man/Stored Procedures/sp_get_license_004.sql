...
-- =============================================
CREATE PROCEDURE [man].[sp_get_license_004]
...
BEGIN
	...
	DECLARE @app_name  NVARCHAR(100) = 'CommonCellController'
			...
			SELECT    CASE WHEN  expire_date <= GETDATE() THEN 'FALSE' ELSE 'TRUE' END   AS Is_Pass  
		...
		--	INNER JOIN [10.29.1.116].TEC_Skill_Test.dbo.SKT_MMainLicense ON SKT_MLicenseStaff_.LicenseCode = SKT_MMainLicense.LicenseCode
