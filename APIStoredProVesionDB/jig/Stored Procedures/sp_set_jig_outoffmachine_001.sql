...
-- =============================================
CREATE PROCEDURE [jig].[sp_set_jig_outoffmachine_001]
...
BEGIN
	...
	--///////////////////  OUT
	IF EXISTS(SELECT jigs.id FROM APCSProDB.trans.jigs WHERE ( barcode = @QRCode OR qrcodebyuser = @QRCode OR smallcode = @QRCode )) AND @jig_state <> 12 --On Machine
	BEGIN
