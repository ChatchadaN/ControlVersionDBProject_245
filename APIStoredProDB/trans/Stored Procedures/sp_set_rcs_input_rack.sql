...
-- =============================================
CREATE PROCEDURE [trans].[sp_set_rcs_input_rack] 
		@emp_id			NVARCHAR(10)
...
BEGIN
    ...
    -- Insert statements for procedure here
		...
		SELECT GETDATE()
			...
			,HOST_NAME()
			,APP_NAME()
			, 'EXEC [trans].[sp_set_rcs_input_rack_003] @LotNo  = ''' + ISNULL(CAST(@Item AS nvarchar(MAX)),'') 
	...
	--		EXEC [APIStoredProVersionDB].[trans].[sp_set_rcs_input_rack_test] 
	--			 	  @OPNo			= 	@OPNo			
	--			   ,  @App_Name		=   @App_Name		
	--			   ,  @Item			=   @Item	
	--			   ,  @Location		=	@Location
	...
	--		EXEC [APIStoredProVersionDB].[trans].[sp_set_rcs_input_rack_002] 
	--			 	  @emp_id		= 	@emp_id			
	--			   ,  @App_Name		=   @App_Name		
	--			   ,  @Item			=   @Item	
	--			   ,  @Location		=	@Location
	...
	------ ########## VERSION 002 ##########
		...
		---- ########## VERSION 003 ##########
			...
			EXEC [APIStoredProVersionDB].[trans].[sp_set_rcs_input_rack_003] 
				 	  @emp_id		= 	@emp_id			
				   ,  @App_Name		=   @App_Name		
				   ,  @Item			=   @Item	
